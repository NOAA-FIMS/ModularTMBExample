...
vonB$log_l_inf[[1]]$is_random_effect<-TRUE
vonB$log_l_inf[[6]]$value<-0.1
vonB$log_l_inf[[6]]$estimable<-TRUE
vonB$log_l_inf[[6]]$is_random_effect<-TRUE

vonB$log_k[[1]]$value<-0.01
vonB$log_k[[1]]$estimable<-TRUE
vonB$log_k[[1]]$is_random_effect<-TRUE
vonB$log_k[[6]]$value<-0.01
vonB$log_k[[6]]$estimable<-TRUE
vonB$log_k[[6]]$is_random_effect<-TRUE
#set up map
for(i in 2:5){
